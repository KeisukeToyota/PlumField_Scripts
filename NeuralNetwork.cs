...
public class NeuralNetwork : MonoBehaviour{
	...
	private string animations,charactor,distance_a,distance_l;
	...
	public NeuralNetwork(int n_in, int n_hid, int n_out, int[] hid_l, double ga, double et, double al, int n_c, int l_n)
	{
		gain = ga;
		eta = et;
		alpha = al;
	...
	public void Select(){
		if (selectAI == "enemy") {
			...
			charactor = "CharControl1";
			distance_a = "approach";
			distance_l = "leave";
		} else if(selectAI == "Player"){
			animations = "Animation";
			charactor = "CharControl";
			distance_a = "leave";
			distance_l = "approach";
		}
	}
